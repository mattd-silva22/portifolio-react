...
export function ProjectCard(props:ProjectCardsTypes){
    ...
    return(
        ...
        <CardContainer>
            ...
            <div className="link-area">
                <a href={props.deployLink} className="visit-btn" target={ "_blank"}>
                ...
                <a href={props.repoLink} className="code-text" target={ "_blank"}>
